          ...
          <div className="flex items-center gap-4">
            {user ? (
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <Link
                  href="/register"
                  className="flex items-center gap-2 px-6 py-2.5 bg-white text-ksu border border-ksu rounded-full font-black text-sm shadow-lg shadow-ksu/10 hover:bg-ksu/5 hover:scale-105 active:scale-95 transition-all"
                >
                  <UserPlus size={18} />
