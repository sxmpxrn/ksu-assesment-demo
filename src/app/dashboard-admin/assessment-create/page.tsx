  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        console.log("DEBUG: Session Fetched Successfully", sessionResponse);
      } catch (err: any) {
        console.error("DEBUG: Failed at getSession()", err);
        throw new Error(`Failed to check session: ${err.message || "Network Error"}`);
      }
